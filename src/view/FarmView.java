...
public class FarmView extends JFrame implements ActionListener{
	...
	public FarmView(City x,Game s)
	{
		...
		{
			if(v.getEconomicalBuildings().get(i) instanceof Farm)
			{
				b=(Farm)v.getEconomicalBuildings().get(i);
			}
		}
		...
		image=new JLabel();
		image.setIcon(new ImageIcon("Farm Final.png"));
