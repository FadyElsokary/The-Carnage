...
public class StableView extends JFrame implements ActionListener{
	...
	public StableView(City x,Game s)
	{
		...
		{
			if(v.getMilitaryBuildings().get(i) instanceof Stable)
			{
				b=(Stable)v.getMilitaryBuildings().get(i);
			}
		}
		...
		image=new JLabel();
		image.setIcon(new ImageIcon("StableFinal.png"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		else
		{
			...
			else
			{
				...
				{
					try {
						p.recruitUnit("Cavalry", v.getName());
					} catch (BuildingInCoolDownException e1) {
						JOptionPane.showMessageDialog(null, "Building is Cooling Down");
