...
public class CairoView extends JFrame implements ActionListener{
	...
	public CairoView(City x,Game g)
	{
		v=x;
		f=g;
		z=g.getPlayer();
		...
		image=new JLabel();
		image.setIcon(new ImageIcon("Cairo Final.jpg"));
		...
		archeryRange.setBounds(50, 700, 250, 40);
		...
		barracks.setBounds(50, 250, 250, 40);
		...
		stable.setBounds(450, 100, 250, 40);
		...
		market.setBounds(1200, 200, 250, 40);
