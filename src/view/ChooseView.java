...
public class ChooseView extends JFrame implements ActionListener{
	...
	private JButton continueSiege;
	private JButton attack;
	private JButton autoResolve;
	
	
	public ChooseView(Army x,Army y,Player c,Game s)
	{
		a=x;
		d=y;
		p=c;
		...
		continueSiege=new JButton("Continue Sieging");
		continueSiege.setBounds(200, 500, 250, 50);
		continueSiege.setFocusable(false);
		continueSiege.setFont(new Font(Font.MONOSPACED,Font.BOLD,15));
